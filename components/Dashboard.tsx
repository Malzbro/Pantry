          ...
          {plan.meals.map((meal, i) => {
            ...
            return (
              <button
                ...
                className={`w-full flex items-start gap-4 md:gap-6 p-4 md:p-6 rounded-2xl text-left transition-all duration-200 animate-in fade-in slide-in-from-bottom-1 ${
                  isToday
              ...
              >
                <div className="relative w-28 h-28 sm:w-32 sm:h-32 md:w-40 md:h-40 rounded-xl overflow-hidden flex-shrink-0 shadow-md ring-1 ring-black/5">
                  <Image
